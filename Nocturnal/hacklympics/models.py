...
class Course(models.Model):
    ...
    teacher = models.ForeignKey("User", related_name="teacher", on_delete=models.CASCADE)  # Added on_delete argument
...
class Exam(models.Model):
    ...
    course = models.ForeignKey("Course", on_delete=models.CASCADE)  # Added on_delete argument
...
class Problem(models.Model):
    ...
    exam = models.ForeignKey("Exam", on_delete=models.CASCADE)  # Added on_delete argument
...
class Answer(models.Model):
    ...
    problem = models.ForeignKey("Problem", on_delete=models.CASCADE)  # Added on_delete argument
    student = models.ForeignKey("User", on_delete=models.CASCADE)  # Added on_delete argument
...
class Message(models.Model):
    ...
    user = models.ForeignKey("User", on_delete=models.CASCADE)  # Added on_delete argument
    exam = models.ForeignKey("Exam", on_delete=models.CASCADE)  # Added on_delete argument
